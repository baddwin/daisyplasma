...
void daisy::createConfigurationInterface(KConfigDialog *parent)
{
  if (m_dialogLauncher == 0)
  {
    ...
    else if ( m_player == QString("XMMS") )m_mainConfigurationUi.comboBox_player->setCurrentIndex(3);
...
void daisy::insertBacks()
{
  ...
  m_appearanceConfigurationUi.comboBoxBackground->addItem( i18n("cavalino-red") );
  ...
  m_appearanceConfigurationUi.comboBoxBackground->addItem( i18n("blueish") );
  m_appearanceConfigurationUi.comboBoxBackground->addItem( i18n("reddish") );
  m_appearanceConfigurationUi.comboBoxBackground->addItem( i18n("rubber-black") );
  m_appearanceConfigurationUi.comboBoxBackground->addItem( i18n("kiwi") );
  ...
  else if ( m_theme_t == QString("cavalino-red") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(4);
  else if ( m_theme_t == QString("mach") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(5);
  else if ( m_theme_t == QString("mach-2") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(6);
  else if ( m_theme_t == QString("shiny-black") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(7);
  else if ( m_theme_t == QString("vidro") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(8);
  else if ( m_theme_t == QString("blueish") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(9);
  else if ( m_theme_t == QString("reddish") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(10);
  else if ( m_theme_t == QString("rubber-black") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(11);
  else if ( m_theme_t == QString("kiwi") ) m_appearanceConfigurationUi.comboBoxBackground->setCurrentIndex(12);
...
void daisy::configAccepted()
{
  ...
  if ( m_type == QString("standard_dock") )
  {
    ...
    else if (m_box_index == 4)m_theme_t = QString("cavalino-red");
    else if (m_box_index == 5)m_theme_t = QString("mach");
    else if (m_box_index == 6)m_theme_t = QString("mach-2");
    else if (m_box_index == 7)m_theme_t = QString("shiny-black");
    else if (m_box_index == 8)m_theme_t = QString("vidro");
    else if (m_box_index == 9)m_theme_t = QString("blueish");
    else if (m_box_index == 10)m_theme_t = QString("reddish");
    else if (m_box_index == 11)m_theme_t = QString("rubber-black");
    else if (m_box_index == 12)m_theme_t = QString("kiwi");
  }
  // Role
  ...
  else if (m_box_index == 3) m_player = QString("XMMS");
  // Mouse over effects
...
void daisy::backgroundChanged( int value )
{
  ...
  if ( m_type == QString("standard_dock") )
  {
    ...
    else if (value == 4)m_theme_t = QString("cavalino-red");
    else if (value == 5)m_theme_t = QString("mach");
    else if (value == 6)m_theme_t = QString("mach-2");
    else if (value == 7)m_theme_t = QString("shiny-black");
    else if (value == 8)m_theme_t = QString("vidro");
    else if (value == 9)m_theme_t = QString("blueish");
    else if (value == 10)m_theme_t = QString("reddish");
    else if (value == 11)m_theme_t = QString("rubber-black");
    else if (value == 12)m_theme_t = QString("kiwi");
...
void daisy::configLauncherAccepted(void)
{
  ...
  connect(m_widgets[m_launtoedit], SIGNAL(clicked()), this, SLOT(launClick()));
  polishLaunchers();
